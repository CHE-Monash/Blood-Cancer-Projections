...
# same criterion as code/supporting/holdout.R — and (ii) in-sample fit on the full
...
#   Rscript code/supporting/knot_selection.R   -> writes output/table_s_knot_selection.csv
...
source("code/supporting/holdout.R")     # build_pop_mat_years, project_one_draw_holdout, holdout_split/years
